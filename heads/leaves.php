				...
				<div class="pb-20">
					<table class="data-table table stripe hover nowrap" id="example">
						...
						<tbody>
							...
							$sql = "SELECT tblleaves.id as leave_id, tblemployees.FirstName, tblemployees.LastName, tblleaves.LeaveType, tblleaves.PostingDate, tblleaves.Status as hod_status, tblleaves.admin_status, tblleaves.principal_status FROM tblleaves INNER JOIN tblemployees ON tblleaves.empid = tblemployees.emp_id WHERE tblemployees.Department = '$hod_department'";
