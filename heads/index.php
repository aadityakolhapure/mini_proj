          ...
          <div class="card-box height-100-p widget-style3">
            ...
            <div class="d-flex flex-wrap">
              <div class="widget-data">
                ...
                <div class="font-14 text-secondary weight-500">Total Faculty in Department</div>
              </div>
      ...
      <div class="card-box mb-30">
        ...
        <div class="pb-20">
          <table class="data-table table stripe hover nowrap">
            ...
            <tbody>
              <?php
              $sql = "SELECT tblleaves.id as lid, tblemployees.FirstName, tblemployees.LastName, tblemployees.emp_id, tblleaves.LeaveType, tblleaves.PostingDate, tblleaves.Status ,tblleaves.admin_status, tblleaves.principal_status
                    FROM tblleaves 
              ...
              ?>
                  <tr>
                    ...
                    <td>
                      <?php
                      $prin_stats = $result->principal_status;
                      if ($prin_stats == 1) {
