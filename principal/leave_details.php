...
if (isset($_POST['update'])) {
	...
	if ($status === '2') {
		$sql = "update tblleaves set principal_remark=:description,principal_status=:status,

			principal_remark_date=:admremarkdate where id=:did";
		...
		$result = mysqli_query($conn, "update tblleaves, tblemployees set tblleaves.principal_remark='$description',tblleaves.principal_status='$status',tblleaves.principal_remark_date='$admremarkdate', tblemployees.Av_leave='$REMLEAVE' where tblleaves.empid = tblemployees.emp_id AND tblleaves.id='$did'");
				...
				<div class="pd-20 card-box mb-30">
					...
					<form method="post" action="">
						...
						?>
									...
									<div class="form-group row">
										<label style="font-size:16px;" class="col-sm-12 col-md-2 col-form-label"><b>Admin Waiting Remarks</b></label>
										<div class="col-sm-12 col-md-10">
											<?php
											...
											<?php else : ?>
												<input type="text" class="selectpicker form-control" data-style="btn-outline-primary" readonly value="<?php echo "Action Taken"; ?>">
											<?php endif ?>
										</div>
									</div>
									<div class="form-group row">
										<label style="font-size:16px;" class="col-sm-12 col-md-2 col-form-label"><b>Principal Waiting Remarks</b></label>
										<div class="col-sm-12 col-md-10">
											<?php
									...
									<div class="form-group row">
										<label style="font-size:16px;" class="col-sm-12 col-md-2 col-form-label"><b>Admin Remark</b></label>
										<div class="col-sm-12 col-md-10">
											<?php
									...
									<div class="row">
										<div class="col-md-3">
											<div class="form-group">
												<label style="font-size:16px;"><b>Action Taken Date By Principal</b></label>
												<?php
