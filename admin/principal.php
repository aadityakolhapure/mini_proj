	...
	<div class="main-container">
		<div class="pd-ltr-20">
			...
			<div class="card-box mb-30">
				<div class="pd-20">
					<h2 class="text-blue h4">ALL Principal</h2>
				</div>
				<div class="col-md-5">
					...
					<table class="data-table table stripe hover nowrap" id="table23">
						...
						<tbody>
							<tr>
								...
								<?php
								$teacher_query = mysqli_query($conn, "select * from tblemployees LEFT JOIN tbldepartments ON tblemployees.Department = tbldepartments.DepartmentShortName where role = 'Principal' ORDER BY tblemployees.emp_id") or die(mysqli_error());
					...
					<div class="weight-500 col-md-6">
						<div class="form-group">
							...
							<div class="modal-footer justify-content-center">
								...
								<form method="post" action="includes/principal_data.php">
